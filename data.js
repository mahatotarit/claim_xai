// transactions data from compromised wallet
let tx_data = [
  {
    ...
    abi: [
      ...
      },
      {
        ...
        name: 'FoundationBasepointsUpdated',
        type: 'event',
      },
      {
        anonymous: false,
      ...
      {
        inputs: [{ internalType: 'address', name: '_newXai', type: 'address' }],
        ...
        outputs: [
          {
            ...
            internalType: 'struct esXai2.RedemptionRequestExt',
            name: '',
            type: 'tuple',
          },
        ],
      ...
      },
      {
        inputs: [
          {
            internalType: 'address',
            name: '_esXaiBurnFoundationRecipient',
            type: 'address',
          },
          {
            internalType: 'uint256',
            name: '_esXaiBurnFoundationBasePoints',
            type: 'uint256',
          },
        ],
        name: 'initialize',
  ...
  },
  {
    ...
    data: {
      function: 'transfer',
      paremeter: [
        '0x2e832593F9Ac729F7997483f14ed83789756D5B5',
